...
override PKGDIR = xconfig_enc_rtos
...
package/%.xdc.inc package/%_xconfig_enc_rtos.c package/%.defs.h: %.xdc $(PKGCFGS)
	@$(MSG) generating interfaces for package xconfig_enc_rtos" (because $@ is older than $(firstword $?))" ...
	$(XSRUN) -f xdc/services/intern/cmd/build.xs $(MK_IDLOPTS) -m package/package.xdc.dep -i package/package.xdc.inc package.xdc

.dlls,em4f .dlls: enc_rtos.pem4f

-include package/cfg/enc_rtos_pem4f.mak
-include package/cfg/enc_rtos_pem4f.cfg.mak
ifeq (,$(MK_NOGENDEPS))
-include package/cfg/enc_rtos_pem4f.dep
endif
enc_rtos.pem4f: package/cfg/enc_rtos_pem4f.xdl
	@


ifeq (,$(wildcard .libraries,em4f))
enc_rtos.pem4f package/cfg/enc_rtos_pem4f.c: .libraries,em4f
endif

package/cfg/enc_rtos_pem4f.c package/cfg/enc_rtos_pem4f.h package/cfg/enc_rtos_pem4f.xdl: override _PROG_NAME := enc_rtos.xem4f
package/cfg/enc_rtos_pem4f.c: package/cfg/enc_rtos_pem4f.cfg
package/cfg/enc_rtos_pem4f.xdc.inc: package/cfg/enc_rtos_pem4f.xdl
package/cfg/enc_rtos_pem4f.xdl package/cfg/enc_rtos_pem4f.c: .interfaces

clean:: clean,em4f
	-$(RM) package/cfg/enc_rtos_pem4f.cfg
	-$(RM) package/cfg/enc_rtos_pem4f.dep
	-$(RM) package/cfg/enc_rtos_pem4f.c
	-$(RM) package/cfg/enc_rtos_pem4f.xdc.inc

clean,em4f::
	-$(RM) enc_rtos.pem4f
.executables,em4f .executables: enc_rtos.xem4f

enc_rtos.xem4f: |enc_rtos.pem4f

-include package/cfg/enc_rtos.xem4f.mak
enc_rtos.xem4f: package/cfg/enc_rtos_pem4f.oem4f 
	$(RM) $@
	@$(MSG) lnkem4f $@ ...
	$(RM) $(XDCCFGDIR)/$@.map
	$(ti.targets.arm.elf.M4F.rootDir)/bin/armcl -fs $(XDCCFGDIR)$(dir $@). -q -u _c_int00 --silicon_version=7M4 -z --strict_compatibility=on  -o $@ package/cfg/enc_rtos_pem4f.oem4f   package/cfg/enc_rtos_pem4f.xdl  -w -c -m $(XDCCFGDIR)/$@.map -l $(ti.targets.arm.elf.M4F.rootDir)/lib/libc.a
	
enc_rtos.xem4f: export C_DIR=
enc_rtos.xem4f: PATH:=$(ti.targets.arm.elf.M4F.rootDir)/bin/;$(PATH)
enc_rtos.xem4f: Path:=$(ti.targets.arm.elf.M4F.rootDir)/bin/;$(PATH)

enc_rtos.test test,em4f test: enc_rtos.xem4f.test

enc_rtos.xem4f.test:: enc_rtos.xem4f
ifeq (,$(_TESTLEVEL))
	@$(MAKE) -R -r --no-print-directory -f $(XDCROOT)/packages/xdc/bld/xdc.mak _TESTLEVEL=1 enc_rtos.xem4f.test
else
	@$(MSG) running $<  ...
	$(call EXEC.enc_rtos.xem4f, ) 
endif

clean,em4f::
	-$(RM) $(wildcard .tmp,enc_rtos.xem4f,*)
...
%,copy:
	...
	$(RM) $@
	$(CP) $< $@
enc_rtos_pem4f.oem4f,copy : package/cfg/enc_rtos_pem4f.oem4f
enc_rtos_pem4f.sem4f,copy : package/cfg/enc_rtos_pem4f.sem4f

$(XDCCFGDIR)%.c $(XDCCFGDIR)%.h $(XDCCFGDIR)%.xdl: $(XDCCFGDIR)%.cfg $(XDCROOT)/packages/xdc/cfg/Main.xs | .interfaces
	@$(MSG) "configuring $(_PROG_NAME) from $< ..."
	$(CONFIG) $(_PROG_XSOPTS) xdc.cfg $(_PROG_NAME) $(XDCCFGDIR)$*.cfg $(XDCCFGDIR)$*

.PHONY: release,xconfig_enc_rtos
ifeq (,$(MK_NOGENDEPS))
-include package/rel/xconfig_enc_rtos.tar.dep
endif
package/rel/xconfig_enc_rtos/xconfig_enc_rtos/package/package.rel.xml: package/package.bld.xml
package/rel/xconfig_enc_rtos/xconfig_enc_rtos/package/package.rel.xml: package/build.cfg
package/rel/xconfig_enc_rtos/xconfig_enc_rtos/package/package.rel.xml: package/package.xdc.inc
package/rel/xconfig_enc_rtos/xconfig_enc_rtos/package/package.rel.xml: .force
	@$(MSG) generating external release references $@ ...
	$(XS) $(JSENV) -f $(XDCROOT)/packages/xdc/bld/rel.js $(MK_RELOPTS) . $@

xconfig_enc_rtos.tar: package/rel/xconfig_enc_rtos.xdc.inc package/rel/xconfig_enc_rtos/xconfig_enc_rtos/package/package.rel.xml
	@$(MSG) making release file $@ "(because of $(firstword $?))" ...
	-$(RM) $@
	$(call MKRELTAR,package/rel/xconfig_enc_rtos.xdc.inc,package/rel/xconfig_enc_rtos.tar.dep)


release release,xconfig_enc_rtos: all xconfig_enc_rtos.tar
clean:: .clean
	-$(RM) xconfig_enc_rtos.tar
	-$(RM) package/rel/xconfig_enc_rtos.xdc.inc
	-$(RM) package/rel/xconfig_enc_rtos.tar.dep
