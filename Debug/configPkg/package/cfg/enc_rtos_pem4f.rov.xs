...
__o = __obj[705]  // ti.sysbios.knl.Task.Instance#1/instance
    ...
    __o['name'] = String(java.net.URLDecoder.decode('speedLoop_TASK', 'UTF-8'))
...
__o = __obj[1057]  
    ...
    __o['cfgScript'] = String(java.net.URLDecoder.decode('C%3A%2FUsers%2FJulio%2Fworkspace_v8%2FQuad_Encoder%2Fenc_rtos.cfg', 'UTF-8'))
    __o['prelink'] = false
